...
import pandas as pd
import numpy as np
from sklearn.compose import ColumnTransformer   #to create a pipeline format
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            num_pipeline = Pipeline(
                steps=[
                    ("imputer", SimpleImputer(strategy="median")),  #handles missing values replacing them with medians
                    ("scaler", StandardScaler(with_mean=False))    #performs standard scaling
                ]
            )
            cat_pipeline = Pipeline(
                steps=[
                    ("imputer", SimpleImputer(strategy="most_frequent")),  #replacing missing values with the modal value 
            ...
            preprocessor = ColumnTransformer(
                [
                    ("num_pipeline", num_pipeline, numerical_columns),  #tuple with pipeline name, steps and input source
